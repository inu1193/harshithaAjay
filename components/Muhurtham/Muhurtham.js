    ...
    <main className='main'>
      <div className={styles.muhurthamSec}>
            <div className={styles.sec1} >
                ...
                <p className={styles.p}><span className='bold'>0<span className='coral'>4</span>-11-2024</span>, <span className='bold'><span className='coral'>9</span>:20</span><span className={styles.am}>AM</span> to <span className='bold'><span className='coral'>10</span>:20</span><span className={styles.am}>AM</span></p>
            </div>
